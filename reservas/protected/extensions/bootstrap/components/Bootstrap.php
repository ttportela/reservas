...
class Bootstrap extends CApplicationComponent
{
	 ...
	 * @since 0.9.11
	 */
	public function registerOthers()
	{
		// Yii::app()->clientScript->registerLessFile($this->getAssetsUrl().'/less/mixins.less');
		// Yii::app()->clientScript->registerLessFile($this->getAssetsUrl().'/less/accordion.less');
		// Yii::app()->clientScript->registerLessFile($this->getAssetsUrl().'/less/component-animations.less');
		
		// Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/css/npm.js');
		// Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/less/component-animations.less');
		
		// Yii::app()->clientScript->registerScriptFile($this->getAssetsUrl().'/js/npm.js');
		Yii::app()->clientScript->registerScriptFile($this->getAssetsUrl().'/js/bootstrap-collapse.js');
